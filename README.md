# TextEncoderLite
TextEncoderLite is a "polyfill" module that allows to replace the [TextEncoder](https://developer.mozilla.org/en-US/docs/Web/API/Encoding_API) API of javascript.<br>
